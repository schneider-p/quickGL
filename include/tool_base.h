...
//	virtual int  cursorLocation(int x, int y){}; // tells if cursor is
//outside (0), inside(1), bottom-edge (21), left-edge (22), top edge(23), right
//edge (24) 	virtual void changeCursor(int x, int y){};
...
// SimpleGL follows the principle of creating all objects (including cameras)
// aligned to axes and then using the matrices to get then in position

class Tool {
protected:
  bool lClick, mClick, rClick; // whether any mouse button was clicked
  bool wheelUp, wheelDown; // whether wheel was moved (user is responsible to
                           // reset this to false)
